...
// 桌面端首启 4 步引导。完成后写 localStorage('videomemo-onboarded') = '1'，路由守卫不再拦。
//
// 1. 后端连通性自检
...
const ONBOARD_KEY = 'videomemo-onboarded'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-pink-50 p-6">
      <div className="w-full max-w-xl rounded-xl border bg-white p-6 shadow-lg">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">欢迎使用 VideoMemo</h1>
        ...
        {step === 1 && (
          <section className="flex flex-col gap-3">
            ...
            <div className="flex gap-2 justify-between items-center">
              <button className="text-sm text-gray-500 hover:text-gray-800" onClick={skip}>跳过</button>
